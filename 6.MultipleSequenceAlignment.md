...
The first step is to gather all the gene sequences you are interested in aligning. We will use the rrsA 16s sequence as a continuation from the [blast tutorial](https://github.com/FierstLab/Bootcamp/blob/main/5.ntBLAST.md). If you have completed this tutorial, then you should have a directory called blast_loop with 5 ecoli genomes and the directory called blast_out. **cd to blast_out** and you should have 5 output files that loop like:
```
