...
<details>
<summary>View your Annotations</summary>

At any point in the process you can and should **look** at your actual annotations. Again many softwares exist to do this. Here we use [IGV](https://igv.org/) (Integrative Genome Viewer).
