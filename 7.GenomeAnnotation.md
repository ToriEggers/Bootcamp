...
[RepeatModeler](https://github.com/Dfam-consortium/RepeatModeler) is used to find repetitive regions.
...
#Build the database
BuildDatabase -name [ECOLI] [ecoli.fasta]

#Run RepeatModeler for de novo repeat identification and characterization
RepeatModeler -threads 8 -database [ECOLI]

#Use the queryRepeatDatabase.pl script inside RepeatMasker/util to extract Rhabditida repeats
python /home/veggers/.conda/envs/repeatmodeler/share/RepeatMasker/famdb.py families -f fasta_acc -ad --curated 'rhabditida' > Rhabditida.repeatmasker

#Combine the files to create a library of de novo and known repeats
cat RM*/consensi.fa.classified Rhabditida.repeatmasker > [sample].repeats
