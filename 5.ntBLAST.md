...
Hit [i] for insert and copy/paste the following script. Make sure you know the name of the file and it's path for both the sequence you want to find (sequence.fasta) and the genome you are BLASTing against (assembly.fasta). 
```
#!/bin/bash
